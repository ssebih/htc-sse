...
public class EquationSecondDegre {
	...
	Scanner scanner = new Scanner(System.in); //(il ne faut jamais le fermer sinon on sera dans une erreur et le programme beugue)
	int delta = 0;
	...
	if (delta == 0) {
		...
		System.out.println("l'équation amdet deux solutions +x et -x");
